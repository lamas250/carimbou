...
const SuccessModal = ({ isOpen, onOpenChange, onClaim }: SuccessModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="glass-card max-w-md mx-auto overflow-hidden">
        <div className="flex flex-col items-center p-6 text-center">
          ...
          >
            You&apos;ve completed your loyalty card! Claim your free meal at the restaurant.
          </p>
