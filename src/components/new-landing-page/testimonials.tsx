...
const testimonials = [
  ...
  },
  {
    id: 3,
    content:
      "Como uma pequena loja de roupas, precisávamos de uma solução simples e acessível para fidelizar clientes. O Carimbou superou todas as nossas expectativas.",
